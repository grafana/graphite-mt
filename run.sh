...
export WSGI_REQUEST_TIMEOUT=${WSGI_REQUEST_TIMEOUT:-65}
export WSGI_MEMORY_LIMIT=${WSGI_MEMORY_LIMIT:-10737418240}
export WSGI_VIRTUAL_MEMORY_LIMIT=${WSGI_VIRTUAL_MEMORY_LIMIT:-10737418240}
export WSGI_MAX_REQUESTS=${WSGI_MAX_REQUESTS:-1000}
export WSGI_REQUEST_TIMEOUT=${WSGI_REQUEST_TIMEOUT:-120}
